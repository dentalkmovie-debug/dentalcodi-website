...
<body style="margin:0;padding:0;background:#fff;font-family:'Noto Sans KR',sans-serif">
  ...
  <!-- 모달: admin.js에서 동적 삽입 (HTML 크기 55KB 절감) -->
  <script>
...
// 초경량 로딩 페이지 - iframe 초기 src로 사용 (실제 레이아웃과 동일한 스켈레톤)
app.get('/embed-loading', (c) => {
  return c.html(`<!DOCTYPE html><html lang="ko"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><style>*{margin:0;padding:0;box-sizing:border-box}body{background:#fff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif}.hd{background:linear-gradient(135deg,#2563eb,#3b82f6);padding:18px 20px}.hd .n{height:22px;width:140px;background:rgba(255,255,255,.35);border-radius:6px;margin-bottom:8px}.hd .s{height:13px;width:220px;background:rgba(255,255,255,.2);border-radius:4px}.tb{display:flex;border-bottom:1px solid #e5e7eb;padding:0 12px;background:#fff}.tb span{padding:12px 16px;font-size:13px;color:#d1d5db}.tb span:first-child{color:#2563eb;border-bottom:2px solid #2563eb;font-weight:700}.ct{padding:16px}.sc{background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:14px 16px;margin-bottom:10px;animation:p 1.5s ease-in-out infinite alternate}.sc .r{display:flex;align-items:center;gap:10px;margin-bottom:12px}.sc .ic{width:36px;height:36px;border-radius:10px;background:linear-gradient(135deg,#dbeafe,#bfdbfe);flex-shrink:0}.sc .tx{flex:1}.sc .t1{height:14px;width:60%;background:#f3f4f6;border-radius:4px;margin-bottom:6px}.sc .t2{height:10px;width:40%;background:#f9fafb;border-radius:3px}.sc .bt{display:flex;gap:6px;padding-left:46px}.sc .b{height:28px;width:70px;background:#f3f4f6;border-radius:8px}@keyframes p{from{opacity:1}to{opacity:.6}}</style></head><body><div class="hd"><div class="n"></div><div class="s"></div></div><div class="tb"><span>대기실</span><span>체어</span><span>공지사항</span><span>설정</span></div><div class="ct"><div class="sc"><div class="r"><div class="ic"></div><div class="tx"><div class="t1"></div><div class="t2"></div></div></div><div class="bt"><div class="b"></div><div class="b"></div><div class="b"></div></div></div><div class="sc"><div class="r"><div class="ic"></div><div class="tx"><div class="t1"></div><div class="t2"></div></div></div><div class="bt"><div class="b"></div><div class="b"></div><div class="b"></div></div></div></div></body></html>`)
})
